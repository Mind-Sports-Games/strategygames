...
class AbaloneForsythTest extends AbaloneTest {
  "sitFromFen" should {
    ...
    "create the situation of Belgian Daisy" in {
      ...
      sitFromFen.get.board.pieces === board.pieces
      sitFromFen.get.player === P1
    }
  }
  ...
  "fen encoding from board after 3 plies" should {
    ...
    "getFen_board describes the updated piecemap" in {
      Forsyth.getFen_board(board) === "ss1SS/sssSSS/1ss1SS1/8/9/8/1SS1ss1/SSSsss/SS1ss"
      Forsyth.getFen_board(sitFromFen.board) === "ss1SS/sssSSS/1ss1SS1/8/9/8/1SS1ss1/SSSsss/SS1ss"
      Forsyth.getFen_board(game.situation.board) === "ss1SS/sssSSS/1ss1SS1/8/9/8/1SS1ss1/SSSsss/SS1ss"
      Forsyth.getFen_board(game4.board) === "1s1SS/sssSSS/1ss1SS1/3s4/4S4/3S4/1SS1ss1/S1Ssss/1S1ss"
    }

    "Forsyth.>> from Abalone namespace describes correctly the board, score, player and number of plies" in {
      Forsyth.>>(sitFromFen) === FEN("ss1SS/sssSSS/1ss1SS1/8/9/8/1SS1ss1/SSSsss/SS1ss 0 0 b 0 1")
