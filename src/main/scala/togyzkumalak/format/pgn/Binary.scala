...
object Binary {
  ...
  private object Reader {
    ...
    // This is hugely inefficient for Togyzkumalak
    // Its what we put in place when we thought the GameLogic might include more than just Togyzkumalak
    ...
    // not even possible in Togyzkumalak
