...
object Ecopening {
  ...
  final case class Go(f: strategygames.go.opening.Ecopening)
      extends Ecopening(
        f.eco,
        f.variantGrouping,
        f.family,
  ...
  final case class Backgammon(f: strategygames.backgammon.opening.Ecopening)
      extends Ecopening(
        f.eco,
        f.variantGrouping,
        f.family,
  ...
  final case class Dameo(f: strategygames.dameo.opening.Ecopening)
      extends Ecopening(
        f.eco,
        f.variantGrouping,
        f.family,
