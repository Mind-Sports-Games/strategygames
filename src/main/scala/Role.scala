...
object Role {
  ...
  def allByForsyth(lib: GameLogic): Map[Char, Role] = lib match {
    ...
    case GameLogic.Togyzkumalak()  => togyzkumalak.Role.allByForsyth.map { case (f, r) => (f, TogyzkumalakRole(r)) }
  }
  ...
  def allByForsyth(lib: GameLogic, gf: GameFamily): Map[Char, Role] = lib match {
    ...
    case GameLogic.Togyzkumalak()  => togyzkumalak.Role.allByForsyth(gf).map { case (f, r) => (f, TogyzkumalakRole(r)) }
  }
  ...
  def allByPgn(lib: GameLogic): Map[Char, Role] = lib match {
    ...
    case GameLogic.Togyzkumalak()  => togyzkumalak.Role.allByPgn.map { case (p, r) => (p, TogyzkumalakRole(r)) }
  }
  ...
  def allByPgn(lib: GameLogic, gf: GameFamily): Map[Char, Role] = lib match {
    ...
    case GameLogic.Togyzkumalak()  => togyzkumalak.Role.allByPgn(gf).map { case (p, r) => (p, TogyzkumalakRole(r)) }
  }
  ...
  def allByName(lib: GameLogic): Map[String, Role] = lib match {
    ...
    case GameLogic.Togyzkumalak()  => togyzkumalak.Role.allByName.map { case (n, r) => (n, TogyzkumalakRole(r)) }
  }
  ...
  def allByName(lib: GameLogic, gf: GameFamily): Map[String, Role] = lib match {
    ...
    case GameLogic.Togyzkumalak()  => togyzkumalak.Role.allByName(gf).map { case (n, r) => (n, TogyzkumalakRole(r)) }
  }
  ...
  def allByGroundName(lib: GameLogic): Map[String, Role] = lib match {
    ...
    case GameLogic.Togyzkumalak()  => togyzkumalak.Role.allByGroundName.map { case (n, r) => (n, TogyzkumalakRole(r)) }
  }
  ...
  def allByGroundName(lib: GameLogic, gf: GameFamily): Map[String, Role] = lib match {
    ...
    case GameLogic.Togyzkumalak()  => togyzkumalak.Role.allByGroundName(gf).map { case (n, r) => (n, TogyzkumalakRole(r)) }
  }
