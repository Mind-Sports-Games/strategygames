...
class OwareFenTest extends Specification with ValidatedMatchers {
  ...
  "fen 1s,1s,4s,4s,4s,4s/4s,4s,1s,1s,4s,4s 4 8 N 11" should {
    val fen = strategygames.mancala.format.FEN("1s,1s,4s,4s,4s,4s/4s,4s,1s,1s,4s,4s 4 8 N 11")
  ...
  "fen 5,13s/4s,1,1s,2,3s a B S 50" should {
    val fen = strategygames.mancala.format.FEN("5,13s/4s,1,1s,2,3s 27 2 S 50")
  ...
  "fen 4s,4s,4s,5s,5s,5s/4s,4s,4s,4s,1,5s 0 0 N 1" should {
    val fen = strategygames.mancala.format.FEN("4s,4s,4s,5s,5s,5s/4s,4s,4s,4s,1,5s 0 0 N 1")
    "player 1 score be 0" in {
      fen.player1Score must_== 0
    }
    "player 2 score be 0" in {
