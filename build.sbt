...
val strategygamesVersion = "10.2.1-s3-ps10-gnubg-analysis-01"
...
lazy val bench = (project in file("bench"))
  ...
  .settings(
    name         := "strategygames-bench",
    scalaVersion := "3.7.4",
    libraryDependencies += "org.specs2" %% "specs2-core" % "5.7.0" % Test,
    publish / skip   := true,
