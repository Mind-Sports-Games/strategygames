...
class OwareVariantTest extends Specification with ValidatedMatchers {
    ...
    "Another cycle position in oware - part 1" should {
        val fen = "DDDDDD/DDDDDD 0 0 S"
        val initialPosition = Api.positionFromFen(fen)
        val uciMoves = List("d1e2", "b2c1", "b1f2", "a2e1", "c1c2", "e2b1", "e1a1", "c2e1", "f1b1", "b2c1", "d1e2",
        "f2e1", "a1b1", "c2a1", "f1e2", "d2f2", "d1f2", "b2c1", "c1f2", "a2c2", "e1c2", "e2c2", "f1b2", "c2c1", "a1f1", "f2b2", "b1c2", "d2c1",
        "e1f2", "e2b2", "d1e2", "c2a2", "f1c2", "b2e1", "b1d2", "a2d1", "a1d1", "e2c2", "b1d1", "c2a2", "c1e1", "d2a2", "d1f2", "a2b1", "a1b1",
        "b2a1", "a1b1", "a2a1", "a1b1", "c2b2", "b1f1", "b2a2", "e1e2", "e2d2", "c1d1", "f2e2", "f1d2", "f2e2", "d1f1", "a2a1", "e1f1", "e2d2",
        "f1e2", "f2e2", "a1b1", "e2c2", "b1c1", "d2b2", "c1d1", "c2a2", "d1e1", "b2a1", "e1f1", "a2b1", "f1f2", "f2e2", "a1c1", "e2d2", "b1d1",
        "d2c2", "c1e1", "c2b2", "d1f1", "b2a2", "e1f2", "a2a1", "f1e2", "f2d2")
    ...
    "Cycle position in oware - what is result?" should {
        ...
        val fen = "DDDDDD/DDDDDD 0 0 S"
        val initialPosition = Api.positionFromFen(fen)
        val uciMoves = List("e1d2", "c2b1", "f1b2", "d2c1", "d1e2", "a2f1", "b1d2", "b2f1", "a1d2", "f2d1", "c1a1", "a2c1", "e1f2", "c2b1",
        "a1e1", "b2b1", "b1d2", "e2d2", "f1b2", "a2c1", "e1e2", "f2b2", "c1e2", "d2c2", "d1d2", "c2a2", "e1f2", "b2a1", "a1e1", "d2c2", "e1f1",
        "c2b2", "d1e1", "b2a2", "f1b2", "a2c1", "e1f1", "e2c2", "f1f2", "d2b2", "b1f1", "b2a1", "f1f2", "c2a1", "e1f1", "f2e2", "a1b1", "a2b1",
        "d1e1", "b2a2", "f1f2", "a2a1", "e1f1", "f2e2", "f1f2", "e2c2", "c1d1", "d2c2", "d1e1", "c2a2", "e1f1", "f2e2", "f1f2", "a2a1", "a1b1",
        "f2e2", "b1c1", "e2c2", "c1d1", "d2c2", "d1e1", "c2a2", "e1f1", "b2a1", "a1b1", "a2b1", "f1f2", "f2e2", "a1b1", "e2d2", "b1c1", "d2c2",
        "c1d1", "c2b2", "d1e1", "b2a2", "e1f1", "a2a1")
