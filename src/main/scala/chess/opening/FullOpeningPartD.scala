...
new FullOpening("D00", "P2mar Gambit", "rnbqkbnr/ppp1pppp/8/3p4/3PP3/8/PPP2PPP/RNBQKBNR b KQkq -"),
new FullOpening("D00", "P2mar-Diemer Gambit", "rnbqkbnr/ppp1pppp/8/8/3Pp3/2N5/PPP2PPP/R1BQKBNR b KQkq -"),
new FullOpening("D00", "P2mar-Diemer Gambit", "rnbqkb1r/ppp1pppp/5n2/3p4/3PP3/2N5/PPP2PPP/R1BQKBNR b KQkq -"),
new FullOpening("D00", "P2mar-Diemer Gambit: Bogoljubov Defense, Mad Dog Attack", "rnbqk2r/ppp1ppbp/5np1/8/2BP3P/2N2N2/PPP3P1/R1BQK2R b KQkq -"),
new FullOpening("D00", "P2mar-Diemer Gambit: Bogoljubov Variation, Kloss Attack", "rnbq1rk1/ppp1ppbp/5np1/8/2BP4/2N2N2/PPP3PP/R1BQ1R1K b - -"),
new FullOpening("D00", "P2mar-Diemer Gambit: Bogoljubov Variation, Nimzowitsch Attack", "rnbqk2r/ppp1ppbp/5np1/4N3/2BP4/2N5/PPP3PP/R1BQK2R b KQkq -"),
new FullOpening("D00", "P2mar-Diemer Gambit: Bogoljubov Variation", "rnbqkb1r/ppp1pp1p/5np1/8/3P4/2N2N2/PPP3PP/R1BQKB1R w KQkq -"),
new FullOpening("D00", "P2mar-Diemer Gambit: Bogoljubov Variation, Studier Attack", "rnbq1rk1/ppp1ppbp/5np1/8/2BP4/2N2N2/PPP3PP/R1B1QRK1 b - -"),
new FullOpening("D00", "P2mar-Diemer Gambit Declined: Brombacher Countergambit", "rnbqkb1r/pp2pppp/5n2/2p5/3Pp3/2N2P2/PPP3PP/R1BQKBNR w KQkq -"),
new FullOpening("D00", "P2mar-Diemer Gambit Declined: Elbert Countergambit", "rnbqkb1r/ppp2ppp/5n2/4p3/3Pp3/2N2P2/PPP3PP/R1BQKBNR w KQkq -"),
new FullOpening("D00", "P2mar-Diemer Gambit Declined: Grosshans Defense", "rn1qkbnr/pppbpppp/8/8/3Pp3/2N5/PPP2PPP/R1BQKBNR w KQkq -"),
new FullOpening("D00", "P2mar-Diemer Gambit Declined: Lamb Defense", "r1bqkb1r/ppp1pppp/2n2n2/8/3Pp3/2N2P2/PPP3PP/R1BQKBNR w KQkq -"),
new FullOpening("D00", "P2mar-Diemer Gambit Declined: Langeheinecke Defense", "rnbqkb1r/ppp1pppp/5n2/8/3P4/2N1pP2/PPP3PP/R1BQKBNR w KQkq -"),
new FullOpening("D00", "P2mar-Diemer Gambit: Diemer-Rosenberg Attack", "rnbqkbnr/ppp1pppp/8/8/3Pp3/4B3/PPP2PPP/RN1QKBNR b KQkq -"),
new FullOpening("D00", "P2mar-Diemer Gambit: Euwe Defense", "rnbqkb1r/ppp2ppp/4pn2/8/3P4/2N2N2/PPP3PP/R1BQKB1R w KQkq -"),
new FullOpening("D00", "P2mar-Diemer Gambit: Euwe Defense, Zilbermints Gambit", "r1bqk2r/ppp1bppp/4pn2/6B1/3n4/2NB1N2/PPP3PP/R2Q1R1K b kq -"),
new FullOpening("D00", "P2mar-Diemer Gambit: Fritz Attack", "rnbqkbnr/ppp1pppp/8/8/2BPp3/8/PPP2PPP/RNBQK1NR b KQkq -"),
new FullOpening("D00", "P2mar-Diemer Gambit: Gedult Gambit", "rnbqkbnr/ppp1pppp/8/8/3Pp3/5P2/PPP3PP/RNBQKBNR b KQkq -"),
new FullOpening("D00", "P2mar-Diemer Gambit: Kaulich Defense", "rnbqkb1r/pp2pppp/5n2/2p5/3P4/2N2N2/PPP3PP/R1BQKB1R w KQkq -"),
new FullOpening("D00", "P2mar-Diemer Gambit: Lemberger Countergambit, Diemer Attack", "rnbqkbnr/ppp2ppp/8/4p3/3Pp3/2N1B3/PPP2PPP/R2QKBNR b KQkq -"),
new FullOpening("D00", "P2mar-Diemer Gambit: Lemberger Countergambit, Endgame Variation", "rnbqkbnr/ppp2ppp/8/4P3/4p3/2N5/PPP2PPP/R1BQKBNR b KQkq -"),
new FullOpening("D00", "P2mar-Diemer Gambit: Lemberger Countergambit, Rassmussen Attack", "rnbqkbnr/ppp2ppp/8/4p3/3Pp3/2N5/PPP1NPPP/R1BQKB1R b KQkq -"),
new FullOpening("D00", "P2mar-Diemer Gambit: Lemberger Countergambit, Simple Variation", "rnbqkbnr/ppp2ppp/8/4p3/3PN3/8/PPP2PPP/R1BQKBNR b KQkq -"),
new FullOpening("D00", "P2mar-Diemer Gambit: Lemberger Countergambit, Sneider Attack", "rnbqkbnr/ppp2ppp/8/4p2Q/3Pp3/2N5/PPP2PPP/R1B1KBNR b KQkq -"),
new FullOpening("D00", "P2mar-Diemer Gambit: Pietrowsky Defense", "r1bqkb1r/ppp1pppp/2n2n2/8/3P4/2N2N2/PPP3PP/R1BQKB1R w KQkq -"),
new FullOpening("D00", "P2mar-Diemer Gambit: Rasa-Studier Gambit", "rnbqkb1r/ppp1pppp/5n2/8/3Pp3/2N1B3/PPP2PPP/R2QKBNR b KQkq -"),
new FullOpening("D00", "P2mar-Diemer Gambit: Ritter Defense", "rnbqkb1r/p1p1pppp/1p3n2/8/3P4/2N2N2/PPP3PP/R1BQKB1R w KQkq -"),
new FullOpening("D00", "P2mar-Diemer Gambit: Rook Pawn Defense", "rnbqkb1r/ppp1ppp1/5n2/7p/3P4/2N2N2/PPP3PP/R1BQKB1R w KQkq -"),
new FullOpening("D00", "P2mar-Diemer Gambit: Ryder Gambit", "rnbqkb1r/ppp1pppp/5n2/8/3P4/2N2Q2/PPP3PP/R1B1KBNR b KQkq -"),
new FullOpening("D00", "P2mar-Diemer Gambit: Schlutter Defense", "r1bqkb1r/pppnpppp/5n2/8/3P4/2N2N2/PPP3PP/R1BQKB1R w KQkq -"),
new FullOpening("D00", "P2mar-Diemer Gambit: Tartakower Variation", "rn1qkb1r/ppp1pppp/5n2/5b2/3P4/2N2N2/PPP3PP/R1BQKB1R w KQkq -"),
new FullOpening("D00", "P2mar-Diemer Gambit: Teichmann Variation", "rn1qkb1r/ppp1pppp/5n2/8/3P2b1/2N2N2/PPP3PP/R1BQKB1R w KQkq -"),
new FullOpening("D00", "P2mar-Diemer Gambit: Vienna Variation", "rn1qkb1r/ppp1pppp/5n2/5b2/3Pp3/2N2P2/PPP3PP/R1BQKBNR w KQkq -"),
new FullOpening("D00", "P2mar-Diemer Gambit: von Popiel Gambit", "rnbqkb1r/ppp1pppp/5n2/6B1/3Pp3/2N5/PPP2PPP/R2QKBNR b KQkq -"),
new FullOpening("D00", "P2mar-Diemer Gambit: von Popiel Gambit, Zilbermints Variation", "rn1qk2r/ppp2ppp/5pb1/1Q6/1b1Pp1P1/2N5/PPP2P1P/R3KBNR b KQkq -"),
new FullOpening("D00", "P2mar-Diemer Gambit: Zeller Defense", "rn1qkbnr/ppp1pppp/8/5b2/3Pp3/2N5/PPP2PPP/R1BQKBNR w KQkq -"),
new FullOpening("D00", "P2mar-Diemer Gambit: Zeller Defense, Soller Attack", "rn1qkb1r/ppp1pppp/5n2/5b2/2BPp3/2N2P2/PPP3PP/R1BQK1NR b KQkq -"),
new FullOpening("D00", "P2mar-Diemer Gambit: Ziegler Defense", "rnbqkb1r/pp2pppp/2p2n2/8/3P4/2N2N2/PPP3PP/R1BQKB1R w KQkq -"),
new FullOpening("D00", "P2mar-Diemer, Lemberger Countergambit", "rnbqkb1r/ppp2ppp/5n2/3pp3/3PP3/2N5/PPP2PPP/R1BQKBNR w KQkq -"),
